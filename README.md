...
Curated list of tools, case studies, and ROI data by business domain.
...
uv pip install -e .
python -m awesome_ai_agents_business.cli --help
python -m unittest discover -s tests -v
```

## Project structure
- `src/awesome_ai_agents_business/`: production code
